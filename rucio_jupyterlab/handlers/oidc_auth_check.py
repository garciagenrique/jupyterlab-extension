...
class OIDCAuthCheckHandler(RucioAPIHandler):
    ...
    def get(self):
        try:
            ...
            oidc_auth_source = rucio_instance.instance_config.get('oidc_env_name') if oidc_auth == 'env' else rucio_instance.instance_cconfig.get('oidc_file_name')
